...
// 获取来自 WordPress 后端注入的数据，增加防错机制
const wp = (typeof window !== 'undefined' && (window as any).th_vars) || {
  translations: {
    home: '首页',
    news: '资讯',
    flash: '快讯',
...
export const MOCK_POSTS: Post[] = [
  {
    ...
    author: { id: 1, name: 'TechHub Editor', avatar: 'https://picsum.photos/seed/a1/100/100' },
